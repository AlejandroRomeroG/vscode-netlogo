...
function parseView3DBinary(data) {
    ...
    const number = () => data.readDoubleBE(take(8));
    const boolean = () => data.readUInt8(take(1)) !== 0;
    const string = () => {
    ...
    return {
        ...
        patchData: data.buffer.slice(data.byteOffset + patchOffset, data.byteOffset + offset),
